subroutine calcspinproduct(iorbs, iorbs2, dout, gout)
use globle
implicit none
...
!
n = cmw(1)
!call zgemm('n', 'n', 1, lmat, lmat, cunity, vl(n), lmat, cmtmp1, lmat, czero, cmtmp2, lmat)
!call zgemm('n', 'n', 1, 1, lmat, cunity, cmtmp2, lmat, vr(n), lmat, czero, cmtmp3, lmat)
gout = real(cmtmp3(n,n))
